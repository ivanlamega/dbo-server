...
{
	ATTRIBUTE_LOGIC_DEFINE(wBaseStr, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wLastStr, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wBaseCon, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wLastCon, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wBaseFoc, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wLastFoc, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wBaseDex, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wLastDex, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wBaseSol, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wLastSol, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wBaseEng, BYTE),
	ATTRIBUTE_LOGIC_DEFINE(wLastEng, BYTE),

	ATTRIBUTE_LOGIC_DEFINE(dwBaseMaxLP, WORD),
	ATTRIBUTE_LOGIC_DEFINE(dwLastMaxLP, WORD),
